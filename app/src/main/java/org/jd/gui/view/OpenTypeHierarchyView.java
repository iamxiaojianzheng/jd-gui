...
public class OpenTypeHierarchyView {
    ...
    public OpenTypeHierarchyView(API api, JFrame mainFrame, TriConsumer<Point, Collection<Container.Entry>, String> selectedTypeCallback) {
        ...
        SwingUtil.invokeLater(() -> {
            openTypeHierarchyDialog = new JDialog(mainFrame, MessageUtil.getMessage("navigation.hierarchytype"), false);
            ...
            JButton openTypeHierarchyOpenButton = new JButton(MessageUtil.getMessage("navigation.hierarchytype.open"));
            ...
            JButton openTypeHierarchyCancelButton = new JButton(MessageUtil.getMessage("navigation.hierarchytype.cancel"));
